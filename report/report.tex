...
Los patrones estáticos, también conocidos como "still lifes", son configuraciones de células que no cambian de una generación a la siguiente. Un ejemplo clásico de un patrón estático es el "bloque", a continuación exploraremos algunos de estos:

\begin{figure}[H]
  \centering
  \includegraphics[width=0.75\textwidth]{../assets/still_life/block/block.png}
  \caption{Patrón bloque - Rules 23/3}
  ...
  \begin{figure}[H]
    ...
    \caption{Patrón integral - Rules 23/3}
    \label{fig:integral}
    \end{figure}
    ...
    \begin{figure}[H]
      ...
      \caption{Patrón ship - Rules 23/3}
      \label{fig:ship}
      \end{figure}
      ...
      \begin{figure}[H]
        ...
        \caption{Patrón honeycomb - Rules 23/3}
        \label{fig:honeycomb}
        \end{figure}
