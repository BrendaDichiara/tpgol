...
Puesto que el Juego de la Vida es un autómata celular, es natural modelarlo como un sistema DEVS. En particular, cada celda en la cuadrícula se modela como un DEVS atómico, que se comunica con sus vecinos a través de sus puertos de entrada y salida.\\
...
\begin{itemize}
\item $X = \{R\}$ es el conjunto de entradas.
